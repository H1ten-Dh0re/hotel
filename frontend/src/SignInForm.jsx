  ...
  const handlePost = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        console.log("Invalid hain kuch");
      }
      console.log("kdlksdjfsl")
    } catch (error) {
        ...
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <a href="#" className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500 text-zinc-400">Forgot password?</a>
                </div>
                <p className="text-orange-800 mt-[0.5rem]">{emailPassError}</p>
                <button type="submit" className="bg-[#4285F4] w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" onClick={handlePost}>Sign in</button>
